...
class TrelloFacadeTest {
    ...
    void testCreateCard() {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test Card", "Test card description", "top", "123");
        TrelloCard trelloCard = new TrelloCard("Test Card", "Test card description", "top", "123");
        CreatedTrelloCardDto createdTrelloCardDto=new CreatedTrelloCardDto("123","Test Card","http");
        ...
        //Then
        assertEquals("Test Card", resultCard.getName());
        assertEquals("123", resultCard.getId());
    }
